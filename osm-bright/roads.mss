...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  ...
  [zoom=13] {
    ...
    [stylegroup='noauto']   { line-width: @rdz13_min / 2; }
  ...
  [zoom=14] {
    ...
    [stylegroup='noauto']   { line-width: @rdz14_min / 2; }
  ...
  [zoom=15] {
    ...
    [stylegroup='noauto']   { line-width: @rdz15_min / 2; }
  ...
  [zoom=16] {
    ...
    [stylegroup='noauto']   { line-width: @rdz16_min / 2; }
  ...
  [zoom=17] {
    ...
    [stylegroup='noauto']   { line-width: @rdz17_min / 2; }
...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{ 
  ...
  [type='steps'] {
    ::line {
      line-color: @pedestrian_line * 0.5;
    }
    ::dash {
      line-color: @motorway_line;
    }
...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  ...
  [zoom=15] {
    [type='steps']   {
      ::line {
        line-width: @rdz15_min / 2; line-dasharray: 1,1;
      }
      ::dash {
        line-width: @rdz15_min / 2; line-dasharray: 1,1;
      }
  ...
  [zoom=16] {
    [type='steps']   {
      ::line {
        line-width: @rdz16_min / 4; line-dasharray: 1,2;
      }
      ::dash {
        line-width: @rdz16_min / 4; line-dasharray: 1,2;
      }
  ...
  [zoom=17] {
    [type='steps']   {
      ::line {
        line-width: @rdz17_min / 4; line-dasharray: 1,2;
      }
      ::dash {
        line-width: @rdz17_min / 4; line-dasharray: 1,2;
      }
  ...
  [zoom>=18] {
    [type='steps'] {
      ::line {
        line-width: @rdz18_min / 4; line-dasharray: 1,2;
      }
      ::dash {
        line-width: @rdz18_min / 4; line-dasharray: 1,2;
      }
